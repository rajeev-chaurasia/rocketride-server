...
RocketRide connects data-processing components into pipelines. This node uses a RocketRide LLM connection to turn pipeline content into structured rows.
