...
RocketRide connects data-processing components into pipelines. This node uses a RocketRide LLM connection to extract and, when enabled, validate facts from the content that flows through the pipeline.
